...
single API. Requests are fulfilled by a **distributed compute network** —
real people running a small, transparent worker application on their own
hardware — plus hosted cloud models. You never need to know which machine
answered your request; the service masks who fulfilled it.
...
- **Real privacy** — your data is not used for training, and providers are
  masked.
